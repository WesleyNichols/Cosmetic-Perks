...
public final class CosmeticPerks extends JavaPlugin {
    ...
    public void initializeAnimations() {
        new AnimationValueInitialize("Fire Circle1",
                Styles.styleValues(Styles.circle(1, 30, new double[]{45, 45, 0}, new double[]{0, 0, 0}),
//                        Styles.circle(1.5, 30, new double[]{45, 0, 0}, new double[]{0, 0, 0}),
//                        Styles.circle(1, 30, new double[]{0, 45, 0}, new double[]{0, 0, 0}),
//                        Styles.circle(2, 30, new double[]{0, 0, 0}, new double[]{0, 0, 0}),
                        Styles.square(3, 9, new double[]{45, 45, 0}, null),
                        Styles.square(3, 9, new double[]{0, 45, 0}, null)
