...
public enum ElytraTrails implements CustomTrail {
    ...
    ElytraTrails(Material material, String effectName, Particle trailEffect, double xOffSet, double yOffSet, double zOffSet, double ParticleSpeed, int ParticleAmount, EquationValues animation, boolean limitedItem) {
